...
local testUsers = {
    ...
    "psychopowerful88", "8", "", "Test9", "Test10",
...
local buttonsPagesData = {{
    ...
    {Text = "No cooldown 100%", ScriptLink = "https://pastebin.com/raw/vxrkkkmF"},
    ...
    {Text = "spt loopbring", ScriptLink = "https://pastebin.com/KYTdXPhP"},
